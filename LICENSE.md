...
**The Selah Georgian Rendering** — სელახის ასოსადმი ერთგული
გადმოცემა ებრაული ბიბლიისა (ერთი გადმოცემა ყოველი მუხლისთვის და
ერთი გლოსა ყოველი სიტყვიერი ერთეულისთვის), თავისი გადასინჯვების
სრულ ისტორიასთან ერთად.

გამოქვეყნებულია **Creative Commons Attribution-ShareAlike 4.0
International (CC BY-SA 4.0)** ლიცენზიით.
...
(WLC), საზოგადო საკუთრება (public domain). გადმოცემა, გლოსები,
ნიშნები და გადასინჯვების ისტორია სელახის პროექტის საკუთარი
ნაშრომია.

---

**The Selah Georgian Rendering** — Selah's letter-faithful rendering
